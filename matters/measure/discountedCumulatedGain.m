...
%% Example of use
%  
%   measuredRunSet = discountedCumulatedGain(pool, runSet, 'CutOffs', 'Standard');
%
            ...
            if(runSetStats{ct, cr}.relevantRetrieved == 0)                
                ...
                if microsoft
                    ...
                    measure = (runTopic{:, 'Assessment'} ./ log2(2:rl + 1)).';
                     ...
                     % log base
                     measure(logBase:rl) = measure(logBase:rl) ./ log2(logBase:rl) .* log2(logBase);
                end;
                ...
                if normalize   
                    ...
                    if microsoft
                        ...
                        % the log base
                        ideal(logBase:il) = ideal(logBase:il) ./ log2(logBase:rl) .* log2(logBase);
                    end;
