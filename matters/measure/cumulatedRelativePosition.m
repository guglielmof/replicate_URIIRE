...
%% Synopsis
%
%   [measuredRunSet, poolStats, runSetStats, inputParams, rho, sigma, tau] = cumulatedRelativePosition(pool, runSet, varargin)
%
...
%% Example of use
%  
%   [measuredRunSet, ~, ~, ~, rho, sigma, tau] = cumulatedRelativePosition(pool, runSet, 'CutOffs', 'Standard');
%
...
%%
function [measuredRunSet, poolStats, runSetStats, inputParams, rho, sigma, tau] = cumulatedRelativePosition(pool, runSet, varargin)
