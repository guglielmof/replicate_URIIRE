%% sersave2
% 
% Saves workspace variables to a MAT file by using serialization and
% specifying the names to be assigned to the variables both in the
% workspace and in the file.

%% Synopsis
%
%   [] = sersave2(fileName, varargin)  
%  
% *Parameters*
%
...
%% Example of use
%  
% It saves the variable named |a| in the currente workspace as a variable
% named |b| in the file |myFile.mat|.
%
%   a = [1 2 3];
%   
%   sersave('myFile.mat', 'WorkspaceVarNames', {'a'}, 'FileVarNames', {'b'})
%   
%% Information
% 
...
%%
function [] = sersave2(fileName, varargin)  
    ...
    % serialize and save each variable
    for v = 1:length(fileVarNames)         
        ...
        m.(fileVarNames{v}) = hlp_serialize(evalin('caller', workspaceVarNames{v}));
    end;
